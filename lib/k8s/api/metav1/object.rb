  ...
  module API
    module MetaV1
      ...
      class ObjectMeta < Resource
        ...
        attribute :ownerReferences, Types::Strict::Array.of(OwnerReference).optional.default(proc { |*args| Array.new }.freeze)
        attribute :initializers, Initializers.optional.default(nil)
        attribute :finalizers, Types::Strict::Array.of(Types::Strict::String).optional.default(proc { |*args| Array.new }.freeze)
