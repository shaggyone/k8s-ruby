  ...
  module API
    module MetaV1
      ...
      class APIResource < Struct
        ...
        attribute :shortNames, Types::Strict::Array.of(Types::Strict::String).optional.default(proc { |*args| Array.new }.freeze)
        attribute :categories, Types::Strict::Array.of(Types::Strict::String).optional.default(proc { |*args| Array.new }.freeze)
      end
